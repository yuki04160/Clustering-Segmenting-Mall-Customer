...
To cluster mall customers and give data-driven recommendations, I conducted two unsupervised machine learning algorithms, K-Means and DBScan, in R using Kaggle dataset - [Mall Customer Segmentation Data](https://www.kaggle.com/vjchoudhary7/customer-segmentation-tutorial-in-python).
## Introduction
...
2. DBScan
   - To find optimal knee (eps/radius), I built a k-distance curve
   - I plotted clusters and interpreted clustering results
## Conclusion
